...
![Using Completion Suggestions](plugin_xml_completion_suggestion.animated.gif){width="706"}{animated="true"}{border-effect="rounded"}
...
[随处搜索](https://www.jetbrains.com/help/idea/searching-everywhere.html)
or
[跳转到文件](https://www.jetbrains.com/help/idea/discover-intellij-idea.html#navigation-and-search)
