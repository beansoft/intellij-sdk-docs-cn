...
<excerpt>IntelliJ Platform的扩展点和监听器一览</excerpt>

IntelliJ Platform %ijPlatform% 一共包含了 1424 Extension Points 和 211 Listeners.

- [](#intellij-platform)
- [](#intellij-community-plugins)
- [](#android-plugin)

> 特定产品的 Extension Point/Listener 列表位于 _Part VIII — Product Specific_.
>
> 另请参阅 [](explore_api.md) for more information and strategies.
>
{type="tip"}
...
| 图标                                | 描述                                | 详情                                                                                                                                                                                                                                                                                                  |
|-----------------------------------|-----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![Deprecated][deprecated]         | 废弃 API                            | Please see code documentation for replacement                                                                                                                                                                                                                                                       |
| ![Experimental API][experimental] | 体验 API                            | Annotated with [`@ApiStatus.Experimental`](https://github.com/JetBrains/java-annotations/blob/master/common/src/main/java/org/jetbrains/annotations/ApiStatus.java), API might be altered or removed without prior notice                                                                           |
| ![Internal API][internal]         | 内部 API                            | Annotated with [`@ApiStatus.Internal`](https://github.com/JetBrains/java-annotations/blob/master/common/src/main/java/org/jetbrains/annotations/ApiStatus.java), should not be used by 3rd party, see [](api_internal.md)                                                                           |
| ![Project-Level][project-level]   | 项目级别的扩展点/主题 | Can have [`Project`](%gh-ic%/platform/core-api/src/com/intellij/openapi/project/Project.java) as constructor parameter<br/><br/>Extension Point: Declared with `area="IDEA_PROJECT"`<br/>Listener: registered in [`<projectListeners>`](plugin_configuration_file.md#idea-plugin__projectListeners) |
| ![Non-Dynamic][non-dynamic]       | 非动态扩展点                            | Installation/update of plugin requires IDE restart ([Dynamic Plugins](dynamic_plugins.md))                                                                                                                                                                                                          |
